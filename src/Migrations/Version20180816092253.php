 ...
 */
final class Version20180816092253 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE membres (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(50) NOT NULL, email VARCHAR(80) NOT NULL, password VARCHAR(80) NOT NULL, role VARCHAR(48) NOT NULL, mainimage VARCHAR(255) DEFAULT NULL, ville VARCHAR(128) DEFAULT NULL, naissance DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
