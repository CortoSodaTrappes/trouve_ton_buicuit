 ...
 */
final class Version20180814082617 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE messagerie (id INT AUTO_INCREMENT NOT NULL, id_expediteur_id INT NOT NULL, id_destinataire_id INT NOT NULL, message LONGTEXT NOT NULL, date DATETIME NOT NULL, created DATETIME NOT NULL, INDEX IDX_14E8F60CAE1B8E04 (id_expediteur_id), INDEX IDX_14E8F60C4DA68CE6 (id_destinataire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
